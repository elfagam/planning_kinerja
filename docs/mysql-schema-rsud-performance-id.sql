-- MySQL 8.0+ schema: Hospital Performance Planning (RSUD)
-- Covers requested tables:
-- users, unit_pengusul, unit_pelaksana, visi, misi, tujuan,
-- indikator_tujuan, sasaran, indikator_sasaran, program,
-- indikator_program, kegiatan, indikator_kegiatan, sub_kegiatan,
-- indikator_sub_kegiatan, rencana_kerja, indikator_rencana_kerja,
-- realisasi_rencana_kerja, target_dan_realisasi.

CREATE DATABASE IF NOT EXISTS rsud_performance_planning
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_unicode_ci;

USE rsud_performance_planning;
...
CREATE TABLE IF NOT EXISTS indikator_rencana_kerja (
  ...
  CONSTRAINT fk_indikator_rk_indikator_sub_kegiatan FOREIGN KEY (indikator_sub_kegiatan_id) REFERENCES indikator_sub_kegiatan(id),
